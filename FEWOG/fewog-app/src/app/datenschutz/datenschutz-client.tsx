...
const DEFAULT_INHALT: unknown[] = [
  ...
  { _type: 'block', _key: 'ds5', style: 'normal', children: [{ _type: 'span', _key: 's', text: 'Die Daten auf dieser Website werden automatisch durch unsere IT-Systeme erfasst (z. B. Browsertyp, Betriebssystem, Uhrzeit des Seitenaufrufs).', marks: [] }], markDefs: [] },
  ...
  { _type: 'block', _key: 'ds29', style: 'h2', children: [{ _type: 'span', _key: 's', text: '5. Plugins und Tools', marks: [] }], markDefs: [] },
